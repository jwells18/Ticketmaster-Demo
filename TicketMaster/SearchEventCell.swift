...
protocol SearchEventCellDelegate {
    func relayDidPressFavorite(sender: UIButton)
}

class SearchEventCell: UICollectionViewCell{
    
    var searchEventCellDelegate: SearchEventCellDelegate!
    ...
    func setupConstraints(){
        ...
        self.imageView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:[favoriteButton(20)]-|", options: NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: viewDict))
        ...
        self.imageView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-[favoriteButton(20)]", options: NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: viewDict))
    }
    ...
    func favoriteButtonPressed(sender: UIButton){
        self.searchEventCellDelegate.relayDidPressFavorite(sender: sender)
    }
}
